...
nohup env DISPLAY=:1 "/home/aics/Màn hình nền/Rl_Bin_Picing/CoppeliaSim_Edu_V4_7_0_rev4_Ubuntu22_04/coppeliaSim.sh" -h -f simulation/simulation.ttt < /dev/null > coppelia.log 2>&1 &
disown
